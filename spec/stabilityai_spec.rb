  ...
  describe "#configure" do
    ...
    it "returns the config" do
      ...
      expect(StabilityAI.configuration.folder).to eq(folder)
			expect(StabilityAI.configuration.organization_id).to eq(organization_id)
      expect(StabilityAI.configuration.uri_base).to eq("https://api.stability.ai")
    ...
    context "without an access token" do
      ...
      it "raises an error" do
        ...
        end.to raise_error(StabilityAI::ConfigurationError)
      end
    end
